<!DOCTYPE html>
<!--[if IE 8]> <html lang="en" class="ie8" data-ng-app="wxApp"> <![endif]-->
<!--[if IE 9]> <html lang="en" class="ie9" data-ng-app="wxApp"> <![endif]-->
<!--[if !IE]><!-->
<html lang="en" data-ng-app="wxApp">
<!--<![endif]-->
<!-- START @HEAD -->
<head>
<!-- START @META SECTION -->
...
<script charset="utf-8"
	src="http://map.qq.com/api/js?v=2.exp&key=UDUBZ-LRE3W-VIQRG-OHFC6-QOTSH-FJBI2"></script>
</head>
<!--/ END HEAD -->