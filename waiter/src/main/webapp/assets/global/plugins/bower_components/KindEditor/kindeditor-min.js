 ...
 */(function(
	...
	function Rb(a, b, c) {
		a.addEventListener ? a.addEventListener(b, c, fb) : a.attachEvent
				&& a.attachEvent("on" + b, c)
	}
	function za(a, b, c) {
		a.removeEventListener ? a.removeEventListener(b, c, fb) : a.detachEvent
	...
	function Ka(a, b, c) {
		...
		aa(a, "keydown", function(d) {
					d.ctrlKey && d.which == b && !d.shiftKey && !d.altKey
							&& (c.call(a), d.stop())
				})
	}
	function ba(a) {
	...
	function I(a) {
		for (var b = {}, c = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g, d; d = c
				.exec(a);) {
	...
	function ia(a, b, c, d) {
		...
		/^\//.test(a) ? a = c + e(a.substr(1)) : /^\w+:\/\//.test(a)
				|| (a = c + e(d + "/" + a));
		b === "relative" ? a = g(c + d, 0).substr(2) : b === "absolute"
				&& a.substr(0, c.length) === c && (a = a.substr(c.length));
		return a
	}
	function U(a, b, c, d, e) {
		a == null && (a = "");
		var c = c || "", d = l(d, !1), e = l(e, "\t"), g = "xx-small,x-small,small,medium,large,x-large,xx-large"
				.split(","), a = a.replace(
				/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function(a, b,
						c, d) {
		...
		var f = [], a = a
				.replace(
						...
						function(a, n, q, r, K, ja, i) {
							var n = n || "", q = q || "", l = r.toLowerCase(), o = K
									|| "", r = ja ? " " + ja : "", i = i || "";
							if (b && !h[l])
								return "";
							r === "" && kb[l] && (r = " /");
							...
							if (o !== "") {
								...
								if (l === "font") {
									...
									m(z, function(a, b) {
										...
										a === "size"
												&& (L["font-size"] = g[parseInt(
														b, 10)
														- 1]
														|| "", delete z[a]);
										a === "face"
												&& (L["font-family"] = b, delete z[a]);
										a === "style" && (F = b)
									});
									F && !/;$/.test(F) && (F += ";");
									m(L, function(a, b) {
	...
	function qb(a, b) {
		...
		/\D/.test(c) ? h += "width:" + c + ";" : c > 0
				&& (h += "width:" + c + "px;");
		/\D/.test(d) ? h += "height:" + d + ";" : d > 0
				&& (h += "height:" + d + "px;");
		c = /realaudio/i.test(e) ? "ke-rm" : /flash/i.test(e)
				? "ke-flash"
				: "ke-media";
		c = '<img class="' + c + '" src="' + a + '" ';
		h !== "" && (c += 'style="' + h + '" ');
	...
	function Ca(a, b) {
		...
		function e(a, b, c) {
			...
			(a = (c.ownerDocument || c).getElementById(a.replace(/\\/g, "")))
					&& d(b, a.nodeName) && Aa(c, a) && e.push(a);
			return e
		}
		function g(a, b, c) {
			...
			if (c.getElementsByClassName) {
				...
				e = e.querySelectorAll((c.nodeName !== "#document" ? c.nodeName
						+ " " : "")
						+ b + "." + a);
				h = 0;
				for (f = e.length; h < f; h++)
		...
		function f(a, b) {
			...
			if (j = /#((?:[\w\-]|\\.)+)$/.exec(a))
				...
				if (c === "id")
					...
					c = [];
					j = (b.ownerDocument || b).getElementsByName(j.replace(
							/\\/g, ""));
					for (var n, r = 0, q = j.length; r < q; r++)
						n = j[r], d(k, n.nodeName) && Aa(b, n)
								&& n.getAttribute("name") !== null && c.push(n);
					k = c
				} else
					k = h(c, j, k, b);
				c = k
		...
		for (var b = b || document, k = [], q, r = /((?:\\.|[^\s>])+|[\s>])/g; q = r
				.exec(a);)
			q[1] !== " " && k.push(q[1]);
		q = [];
		if (k.length == 1)
				...
				if (z > 0) {
					...
					for (s = q.length; L < s; L++) {
						...
						for (t = i.length; F < t; F++)
							p = i[F], r ? o === p.parentNode && l.push(p) : l
									.push(p)
					}
					q = l
				} else
	...
	function Xb(a, b) {
		var c = W(a), d = ga(b), e = "";
		c.getComputedStyle ? (c = c.getComputedStyle(a, null), e = c[d]
				|| c.getPropertyValue(b) || a.style[d]) : a.currentStyle
	...
	function Qa(a, b, c) {
		function d(d, e, g) {
			...
			b
					&& (k = d.cloneNode(!0), k = e > 0 ? k.splitText(e) : k, g < h
							&& k.splitText(g - e));
			if (c) {
				var n = d;
				...
				if (n > 0)
					if (i.nodeType == 1)
						if (q >= 0 && r <= 0)
							...
							&& (i = i == k.startContainer ? d(i, k.startOffset,
									i.nodeValue.length) : i == k.endContainer
									? d(i, 0, k.endOffset)
									: d(i, 0, i.nodeValue.length), b))
						try {
							l.appendChild(i)
						} catch (ja) {
						}
		...
		var h = a.doc, f = [], k = a.cloneRange().down(), n = -1, q = -1, r = -1, m = -1, l = a
				.commonAncestor(), i = h.createDocumentFragment();
		if (l.nodeType == 3)
			return l = d(l, a.startOffset, a.endOffset), b && i.appendChild(l), e(), b
					? i
					: a;
		g(l, i);
		c && a.up().collapse(!0);
	...
	function sb(a, b) {
		...
		for (var q = 0, r = g.length; q < r; q++) {
			...
			if (i.nodeType == 1) {
				...
				o.isControl()
						&& (m = c.createElement("span"), o.after(m), p = m, j += o
								.text().replace(/\r\n|\n|\r/g, "").length);
				na(l, p);
				...
				i.nodeType == 3
						&& (n.moveStart("character", i.nodeValue.length), j += i.nodeValue.length);
			k < 0 && (h = i)
		}
		if (k < 0 && h.nodeType == 1)
			return {
	...
	function tb(a, b) {
		...
		if (a.nodeType == 1 && a.childNodes.length > 0) {
			...
			if (g.nodeType == 1) {
				var h = f(g), j;
				h.isControl()
						&& (j = c.createElement("span"), e ? h.before(j) : h
								.after(j), g = j);
				na(d, g);
				d.collapse(e);
				j && f(j).remove();
	...
	function yb(a, b, c) {
		...
		if (a.type === 1 && (b = wb(b), b[c])) {
			for (var c = b[c].split(","), b = !1, d = 0, e = c.length; d < e; d++) {
				...
				var h = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(g), g = h[2];
				h[1] ? (g = ga(g), a[0].style[g] && (a[0].style[g] = "")) : a
						.removeAttr(g)
			}
			b && a.remove(!0)
		}
	...
	function Wa(a) {
		...
		d.mousedown(function(a) {
					function j(a) {
						a.preventDefault();
						var b = f(V(a.target)), e = R((b.data("pos-x") || 0)
								+ a.pageX - p), a = R((b.data("pos-y") || 0)
								+ a.pageY - s);
					...
					function n(a) {
						a.preventDefault();
						f(g).unbind("mousemove", j).unbind("mouseup", n)
								.unbind("selectstart", k);
						i.releaseCapture && i.releaseCapture()
					}
					a.stopPropagation();
					var i = d.get(), r = t(b.css("left")), l = t(b.css("top")), m = b
							.width(), o = b.height(), p = a.pageX, s = a.pageY;
					e && e();
	...
	function bb(a, b) {
		var c = document.getElementsByTagName("head")[0]
				|| (P ? document.body : document.documentElement), d = document
		...
		d.onload = d.onreadystatechange = function() {
			if (!this.readyState || this.readyState === "loaded")
				b && b(), d.onload = d.onreadystatechange = null, c
						.removeChild(d)
		}
	}
	function Fb(a) {
	...
	function cb(a) {
		for (var b = document.getElementsByTagName("head")[0]
				|| (P ? document.body : document.documentElement), c = document
				.createElement("link"), d = Fb(ia(a, "absolute")), e = f(
				'link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)
			...
			if (a.useContextmenu) {
				if (a._contextmenus.length !== 0) {
					...
					if (d.length > 0) {
						...
						b.clientY + j >= g.clientHeight - 100
								&& h.pos(h.x, t(h.y) - j);
		...
		if (!(o && d !== "br") && (!Y || !(A < 3 && d !== "p"))
			...
			f(c).keyup(function(e) {
				if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey)
						&& d != "br")
					if (Y) {
						var e = b.cmd.commonAncestor("p"), j = b.cmd
								.commonAncestor("a");
						j
								&& j.text() == ""
								&& (j.remove(!0), b.cmd.range
										.selectNodeContents(e[0]).collapse(!0), b.cmd
										.select())
					} else if (b.cmd.selection(), e = a(b.cmd.range), !(e == "marquee" || e == "select"))
						if (g[e] || Q(c, "formatblock", "<p>"), e = b.cmd
								.commonAncestor("div")) {
		...
		f(b).keydown(function(c) {
			if (c.which == 9)
				if (c.preventDefault(), a.afterTab)
					...
					d.shrink();
					d.collapsed && d.startContainer.nodeType == 1
	...
	function Kb(a, b) {
		...
		if (a.length === 0)
			return this;
		c.designMode
				? (e = this.cmd.range, g = e.createBookmark(!0), g.html = d.innerHTML)
				: g = {
					html : d.innerHTML
				};
		Jb(b, g);
		...
		c.designMode ? (c.html(h.html), h.start
				&& (e.moveToBookmark(h), this.select())) : f(d).html(T(h.html));
		return this
	}
	function ua(a) {
		function b(a, b) {
	...
	function Lb(a, b) {
		...
		if ((d = f(a)) && d.length !== 0) {
			...
			if (O[e.langType])
				return c(e);
			bb(		e.langPath + e.langType + ".js?ver="
	...
	if (!w.KindEditor) {
		...
		var Ha = "4.1.10 (2013-11-23)", p = navigator.userAgent.toLowerCase(), o = p
				.indexOf("msie") > -1
				&& p.indexOf("opera") == -1, Yb = p.indexOf("msie") == -1
				&& p.indexOf("trident") > -1, Y = p.indexOf("gecko") > -1
				&& p.indexOf("khtml") == -1, X = p.indexOf("applewebkit") > -1, Pa = p
				.indexOf("opera") > -1, ec = p.indexOf("mobile") > -1, fc = /ipad|iphone|ipod/
				.test(p), P = document.compatMode != "CSS1Compat", H = !w.getSelection, A = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/
				.exec(p)) ? p[1] : "0", Ga = (new Date).getTime(), R = Math.round, f = {
			DEBUG : !1,
			VERSION : Ha,
			IE : o,
			GECKO : Y,
		...
		var fb = !1, Ob = u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"), p = u("33..40"), db = {};
		m(Ob, function(a, b) {
					db[a] = b
				});
		m(p, function(a, b) {
		...
		var hc = "altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which"
				.split(",");
		E(gb, {
					init : function(a, b) {
						...
						if (!c.relatedTarget && c.fromElement)
							c.relatedTarget = c.fromElement === c.target
									? c.toElement
									: c.fromElement;
						...
						if (!c.which && c.button !== i)
							c.which = c.button & 1 ? 1 : c.button & 2
									? 3
									: c.button & 4 ? 2 : 0;
						switch (c.which) {
							case 186 :
		...
		E(D, {
			...
			attr : function(a, b) {
				...
				if (b === i)
					return b = c.length < 1 ? null : Ba(c[0], a), b === null
							? ""
							: b;
				c.each(function() {
							Na(this, a, b)
			...
			removeClass : function(a) {
				this.each(function() {
							if (xa(a, this.className, " "))
								this.className = B(this.className.replace(
										RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
						});
				return this
			},
			...
			val : function(a) {
				if (a === i) {
					...
					return this.each(function() {
								Nb[Oa(this)] ? this.value = a : Na(this,
										"value", a)
							}), this
			},
			css : function(a, b) {
			...
			pos : function() {
				...
				if (a)
					if (a.getBoundingClientRect)
						a = a.getBoundingClientRect(), c = ca(this.doc), b = a.left
								+ c.x, c = a.top + c.y;
					else
						for (; a;)
			...
			after : function(a) {
				this.each(function() {
							this.nextSibling
									? this.parentNode.insertBefore(f(a)[0],
											this.nextSibling)
			...
			if (!(a === i || a === null)) {
				if (typeof a === "string") {
					...
					if (a.length !== d || /<.+>/.test(a)) {
						var d = (b ? b.ownerDocument || b : document)
								.createElement("div"), e = [];
						d.innerHTML = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'
								+ a;
		...
		E(M, {
			...
			setStartAfter : function(a) {
				return this
						.setStart(a.parentNode || this.doc, f(a).index() + 1)
			},
			...
			selectNodeContents : function(a) {
				...
				b = b.children();
				if (b.length > 0)
					return this.setStartBefore(b[0])
							.setEndAfter(b[b.length - 1]);
			...
			cloneRange : function() {
				return (new M(this.doc)).setStart(this.startContainer,
			...
			insertNode : function(a) {
				...
				b.nodeType == 1
						...
						: b.nodeType == 3
								&& (c === 0
										? (b.parentNode.insertBefore(a, b), b.parentNode === d
												&& (e += k))
										: c >= b.nodeValue.length
												...
												: (j = c > 0
														? b.splitText(c)
														: b, b.parentNode
														.insertBefore(a, j), b === d
														&& (d = j, e -= c)));
				g ? this.setStartBefore(g).setEndAfter(f) : this.selectNode(a);
				if (this.compareBoundaryPoints(da, this.cloneRange().setEnd(d,
								e)) >= 1)
					return this;
			...
			get : function(a) {
				...
				if (!H) {
					b = b.createRange();
					try {
						b.setStart(this.startContainer, this.startOffset), b
				...
				if (a && this.isControl())
					return b = b.body.createControlRange(), b
							.addElement(this.startContainer.childNodes[this.startOffset]), b;
				a = this.cloneRange().down();
				b = b.body.createTextRange();
				b.setEndPoint("StartToStart", tb(a.startContainer,
								a.startOffset));
			...
			up : function() {
				function a(a, d, e) {
					a.nodeType == 3
							&& (d === 0 ? e ? b.setStartBefore(a) : b
									.setEndBefore(a) : d == a.nodeValue.length
									&& (e ? b.setStartAfter(a) : b
											.setEndAfter(a)))
				}
				var b = this;
				a(b.startContainer, b.startOffset, !0);
			...
			shrink : function() {
				for (var a, b = this.collapsed; this.startContainer.nodeType == 1
						&& (a = this.startContainer.childNodes[this.startOffset])
						&& a.nodeType == 1 && !f(a).isSingle();)
					this.setStart(a, 0);
				if (b)
			...
			createBookmark : function(a) {
				...
				if (!this.collapsed)
					b = c.cloneNode(!0), b.id = "__kindeditor_bookmark_end_"
							+ Qb++ + "__";
				b
						&& this.cloneRange().collapse(!1).insertNode(b)
								.setEndBefore(b);
			...
			moveToBookmark : function(a) {
				var b = this.doc, c = f(a.start, b), a = a.end
						? f(a.end, b)
						: null;
				if (!c || c.length < 1)
					return this;
		...
		E(oa, {
			...
			selection : function(a) {
				...
				this.sel = Sa(b);
				if (c)
					return this.range = Ra(c), f(this.range.startContainer).name == "html"
							&& this.range.selectNodeContents(b.body)
									.collapse(!1), this;
				a && this.range.selectNodeContents(b.body).collapse(!1);
				return this
			},
			select : function(a) {
				var a = l(a, !0), b = this.sel, c = this.range.cloneRange()
						.shrink(), d = c.startContainer, e = c.startOffset, g = V(d), h = this.win, j, k = !1;
				if (a && d.nodeType == 1 && c.collapsed) {
					...
					if (X
							&& (a = d.childNodes, f(d).isInline() || e > 0
									&& f(a[e - 1]).isInline() || a[e]
									&& f(a[e]).isInline()))
				...
				if (H)
					...
					k && c.collapse(!1), j = c.get(!0), b.removeAllRanges(), b
							.addRange(j), g !== document
							&& (c = f(j.endContainer).pos(), h.scrollTo(c.x,
									c.y));
				h.focus();
				return this
			},
			wrap : function(a) {
				...
				c = f(a, this.doc);
				if (b.collapsed)
					return b.shrink(), b.insertNode(c[0])
							.selectNodeContents(c[0]), this;
				if (c.isBlock()) {
				...
				f(a).scan(function(a) {
					if (!g && a == e.start)
						...
						if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
							for (var n; (n = b.parent()) && n.isStyle()
									&& n.children().length == 1;)
								b = n;
							n = c;
							n = n.clone(!0);
			...
			split : function(a, b) {
				for (var c = this.range, d = c.doc, e = c.cloneRange()
						.collapse(a), g = e.startContainer, h = e.startOffset, j = g.nodeType == 3
						? g.parentNode
						: g, k = !1, n; j && j.parentNode;) {
					n = f(j);
					if (b) {
						if (!n.isStyle())
							break;
				...
				if (k)
					d = d.createElement("span"), c.cloneRange().collapse(!a)
							.insertNode(d), a ? e.setStartBefore(j.firstChild)
							.setEnd(g, h) : e.setStart(g, h)
							.setEndAfter(j.lastChild), g = e.extractContents(), h = g.firstChild, k = g.lastChild, a
							? (e.insertNode(g), c.setStartAfter(k)
									.setEndBefore(d))
							: (j.appendChild(g), c.setStartBefore(d)
									.setEndBefore(h)), e = d.parentNode, e == c.endContainer
							&& (j = f(d).prev(), g = f(d).next(), j && g
									&& j.type == 3 && g.type == 3 ? c.setEnd(
									j[0], j[0].nodeValue.length) : a
									|| c
											.setEnd(c.endContainer, c.endOffset
															- 1)), e
							.removeChild(d);
				return this
			},
			remove : function(a) {
				...
				c.enlarge();
				if (c.startOffset === 0) {
					for (var d = f(c.startContainer), e; (e = d.parent())
			...
			commonNode : function(a) {
				...
				var c = this.range, d = c.endContainer, c = c.endOffset, e = d.nodeType == 3
						|| c === 0 ? d : d.childNodes[c - 1], g = b(e);
				if (g)
					return g;
			...
			commonAncestor : function(a) {
				...
				var c = this.range, d = c.startContainer, e = c.startOffset, g = c.endContainer, c = c.endOffset, g = g.nodeType == 3
						|| c === 0 ? g : g.childNodes[c - 1], d = b(d.nodeType == 3
						|| e === 0 ? d : d.childNodes[e - 1]), e = b(g);
				if (d && e && d === e)
					return f(d);
				return null
			},
			...
			val : function(a) {
				...
				if (a === "fontfamily" || a === "fontname")
					return c = vb(b, "fontname"), c = c.replace(/['"]/g, ""), c
							.toLowerCase();
				if (a === "formatblock") {
					c = vb(b, a);
				...
				if (a === "forecolor")
					return (a = this.commonNode({
								"*" : ".color"
							})) && (c = a.css("color")), c = ya(c), c === ""
							&& (c = "default"), c.toLowerCase();
				if (a === "hilitecolor")
					return (a = this.commonNode({
								"*" : ".background-color"
							})) && (c = a.css("background-color")), c = ya(c), c === ""
							&& (c = "default"), c.toLowerCase();
				return c
			},
			toggle : function(a, b) {
			...
			inserthtml : function(a, b) {
				function c(a, b) {
					var b = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'
							+ b, c = a.get();
			...
			unlink : function() {
				...
				if (b.collapsed) {
					...
					X
							...
							&& (a = f(b.startContainer).parent(), a.name === "a"
									&& a.remove(!0))
				} else
					Q(a, "unlink", null);
				return this
		...
		E(S, {
			init : function(a) {
				...
				a.src ? f(a.src).replaceWith(b.div) : f(b.doc.body)
						.append(b.div);
			...
			pos : function(a, b, c) {
				c = l(c, !0);
				if (a !== null
						&& (a = a < 0 ? 0 : s(a), this.div.css("left", a), c))
					this.x = a;
				if (b !== null
						&& (b = b < 0 ? 0 : s(b), this.div.css("top", b), c))
					this.y = b;
				return this
			},
			autoPos : function(a, b) {
				...
				if (this._alignEl) {
					var g = f(this._alignEl), h = g.pos(), c = R(g[0].clientWidth
							/ 2 - c / 2), d = R(g[0].clientHeight / 2 - d / 2);
					x = c < 0 ? h.x : h.x + c;
					y = d < 0 ? h.y : h.y + d
				} else
					h = G(this.doc), x = R(e.x + (h.clientWidth - c) / 2), y = R(e.y
							+ (h.clientHeight - d) / 2);
				o && A < 7 || P || (x -= e.x, y -= e.y);
				return this.pos(x, y)
			},
			...
			init : function(a) {
				function b() {
					...
					X && f(b).click(function(a) {
						f(a.target).name === "img"
								&& (k.selection(!0), k.range
										.selectNode(a.target), k.select())
					});
					if (o)
						c._mousedownHandler = function() {
							...
							a.shrink();
							a.isControl() && c.blur()
						}, f(document).mousedown(c._mousedownHandler), f(b)
								.keydown(function(a) {
									if (a.which == 8) {
										k.selection();
										var b = k.range;
										b.isControl()
												&& (b.collapse(!0), f(b.startContainer.childNodes[b.startOffset])
														.remove(), a
														.preventDefault())
									}
								});
					...
					o
							? (b.body.disabled = !0, b.body.contentEditable = !0, b.body
				...
				var d = l(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, j = location.protocol != "res:"
						&& location.host.replace(/:\d+/, "") !== document.domain, k = "document.open();"
						+ (j
						...
						: "";
				c.iframe = f('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"'
						+ k + "></iframe>").css("width", "100%");
				c.textarea = f('<textarea class="ke-edit-textarea" hidefocus="true"></textarea>')
						.css("width", "100%");
				c.tabIndex = isNaN(parseInt(a.tabIndex, 10)) ? c.srcElement
			...
			html : function(a, b) {
				...
				if (this.designMode) {
					...
					if (a === i)
						return a = b
								? "<!doctype html><html>"
										+ c.parentNode.innerHTML + "</html>"
								: c.innerHTML, this.beforeGetHtml
								&& (a = this.beforeGetHtml(a)), Y
								&& a == "<br />" && (a = ""), a;
		...
		E(Da, S, {
					init : function(a) {
						...
						function c(a, c) {
							var d = b(a.target);
							if (d && !d.hasClass("ke-disabled")
									&& !d.hasClass("ke-selected"))
								d[c]("ke-on")
						}
						var d = this;
					...
					get : function(a) {
						...
						return this._itemMap[a] = f("span.ke-icon-" + a,
								this.div).parent()
					},
					select : function(a) {
					...
					disableAll : function(a, b) {
						...
						b && (d = u(b));
						(a === i ? !c.disableMode : a) ? (f("span.ke-outline",
								c.div).each(function() {
							var a = f(this), b = a[0].getAttribute("data-name",
									2);
							d[b] || c.disable(a)
						}), c.disableMode = !0) : (f("span.ke-outline", c.div)
								.each(function() {
									var a = f(this), b = a[0].getAttribute(
											"data-name", 2);
									d[b] || c.enable(a)
								}), c.disableMode = !1);
						return c
		...
		E(ra, S, {
			...
			addItem : function(a) {
				if (a.title === "-")
					...
					var b = f('<div class="ke-menu-item" unselectable="on"></div>'), c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = s(a.height), g = l(
							a.iconClass, "");
					this.div.append(b);
					e && (b.css("height", e), d.css("line-height", e));
					var h;
					this.centerLineMode
							&& (h = f('<div class="ke-inline-block ke-menu-item-center"></div>'), e
									&& h.css("height", e));
		...
		E(sa, S, {
			init : function(a) {
				...
				for (var e = 0; e < b.length; e++)
					for (var c = a.insertRow(e + 1), g = 0; g < b[e].length; g++)
						d = c.insertCell(g), this._addAttr(d, b[e][g],
								"ke-colorpicker-cell")
			},
			_addAttr : function(a, b, c) {
				...
				b
						? a
								.append(f('<div class="ke-colorpicker-cell-color" unselectable="on"></div>')
		...
		E(ab, {
			init : function(a) {
				var b = f(a.button), c = a.fieldName || "file", d = a.url || "", e = b
						.val(), g = a.extraParams || {}, h = b[0].className
						|| "", j = a.target || "kindeditor_upload_iframe_"
						+ (new Date).getTime();
				...
				var k = [], i;
				for (i in g)
					k.push('<input type="hidden" name="' + i + '" value="'
							+ g[i] + '" />');
				c = [
						'<div class="ke-inline-block ' + h + '">',
						a.target ? "" : '<iframe name="' + j
						...
						'<input type="button" class="ke-button-common ke-button" value="'
								+ e + '" />',
						"</span>",
						'<input type="file" class="ke-upload-file" name="' + c
								+ '" tabindex="-1" />',
				...
				this.div = c;
				this.button = b;
				this.iframe = a.target ? f('iframe[name="' + j + '"]') : f(
						"iframe", c);
			...
			submit : function() {
				...
				b.bind("load", function() {
					...
					c.reset();
					f(c).remove(!0);
					var c = f.iframeDoc(b), d = c.getElementsByTagName("pre")[0], e = "", g, e = d
							? d.innerHTML
							: c.body.innerHTML, e = fa(e);
					b[0].src = "javascript:false";
					try {
						g = f.json(e)
					} catch (h) {
						a.options.afterError.call(a, "<!doctype html><html>"
										+ c.body.parentNode.innerHTML
										+ "</html>")
					}
		...
		E(ta, S, {
			init : function(a) {
				...
				var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, g = a.yesBtn, h = a.noBtn, j = a.closeBtn, k = l(
						a.showMask, !0);
				this.div.addClass("ke-dialog").bind("click,mousedown",
						function(a) {
							a.stopPropagation()
						});
				var i = f('<div class="ke-dialog-content"></div>')
						.appendTo(this.div);
				o && A < 7
						? this.iframeMask = f('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>')
								.appendTo(this.div)
						: b
								&& f('<div class="ke-dialog-shadow"></div>')
										.appendTo(this.div);
				b = f('<div class="ke-dialog-header"></div>');
				i.append(b);
				b.html(c);
				this.closeIcon = f('<span class="ke-dialog-icon-close" title="'
						+ j.name + '"></span>').click(j.click);
				...
				m(		[{
							...
							if (this.btn) {
								var a = this.btn, a = a || {}, b = a.name || "", c = f('<span class="ke-button-common ke-button-outer" title="'
										+ b + '"></span>'), b = f('<input class="ke-button-common ke-button" type="button" value="'
										+ b + '" />');
				...
				this.height
						&& a.height(t(this.height) - b.height() - q.height());
			...
			showLoading : function(a) {
				...
				this.loading = f('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" style="margin-top:'
						...
						+ 'px;">'
						+ a
						+ "</div></div>").width(b.width()).height(b.height())
		...
		f.tabs = function(a) {
			...
			b.select = function(a) {
				...
				m(e, function(c, d) {
							d.unbind();
							c === a ? (d.addClass("ke-tabs-li-selected"), f(d
		...
		f.ajax = function(a, b, c, d, e) {
			var c = c || "GET", e = e || "json", g = w.XMLHttpRequest
		...
		ua.prototype = {
			...
			updateState : function() {
				...
				m(
						"justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,subscript,superscript,bold,italic,underline,strikethrough"
								.split(","), function(b, c) {
							a.cmd.state(c) ? a.toolbar.select(c) : a.toolbar
									.unselect(c)
						});
				return a
			},
			...
			create : function() {
				...
				var d = c ? G().clientWidth + "px" : b.width, e = c
						? G().clientHeight + "px"
						: b.height;
				if (o && A < 8 || P)
					e = s(t(e) + 2);
				...
				var h = f(".toolbar", g), j = f(".edit", g), k = b.statusbar = f(
						".statusbar", g);
				...
				if (c) {
					...
					b._fullscreenExecuted
							&& (f(document.body).css({
										height : "",
										overflow : ""
									}), f(document.body.parentNode).css(
									"overflow", "")), b._scrollPos
							&& w.scrollTo(b._scrollPos.x, b._scrollPos.y);
				var i = [];
				...
				var h = b.toolbar = Cb({
					...
					beforeGetHtml : function(a) {
						a = b.beforeGetHtml(a);
						a = T(Fa(a));
						return U(a, b.filterMode ? b.htmlTags : null,
								b.urlType, b.wellFormatMode, b.indentChar)
					},
					beforeSetHtml : function(a) {
					...
					afterCreate : function() {
						...
						if (b._undoStack.length > 0) {
							...
							a.start
									&& (b.html(a.html), m.cmd.range
											.moveToBookmark(a), b.select())
						}
						b.afterCreate();
				...
				c
						? (b._fullscreenResizeHandler = function() {
							b.isCreated
									&& b.resize(G().clientWidth,
											G().clientHeight, !1)
						}, f(w).bind("resize", b._fullscreenResizeHandler), h
								.select("fullscreen"), k.first().css(
								"visibility", "hidden"), k.last().css(
								"visibility", "hidden"))
						: (Y && f(w).bind("scroll", function() {
									b._scrollPos = ca()
								}), b.resizeType > 0 ? Wa({
									moveEl : g,
									clickEl : k,
								...
								}) : k.first().css("visibility", "hidden"), b.resizeType === 2
								? Wa({
											moveEl : g,
											clickEl : k.last(),
											moveFn : function(a, c, d, e, g, f) {
			...
			resize : function(a, b, c) {
				...
				if (a
						&& (/%/.test(a)
								|| (a = t(a), a = a < this.minWidth
										? this.minWidth
										: a), this.container.css("width", s(a)), c))
					this.width = s(a);
				if (b
						&& (b = t(b), editHeight = t(b)
								- this.toolbar.div.height()
								- this.statusbar.height(), editHeight = editHeight < this.minHeight
								? this.minHeight
								: editHeight, this.edit.setHeight(editHeight), c))
					this.height = s(b);
				return this
			},
			select : function() {
			...
			text : function(a) {
				return a === i ? B(this.html().replace(/<(?!img|embed).*?>/ig,
			...
			exec : function(a) {
				var a = a.toLowerCase(), b = this.cmd, c = J(a,
			...
			addBookmark : function(a) {
				...
				if (a
						...
						&& Math
								.abs(d.length
										- T(this._undoStack[this._undoStack.length
												- 1].html).length) < this.minChangeSize)
					return this;
				b.designMode && !this._firstAddBookmark
						? (b = this.cmd.range, a = b.createBookmark(!0), a.html = Fa(c.innerHTML), b
								.moveToBookmark(a))
						: a = {
							html : d
						};
			...
			readonly : function(a) {
				...
				b.designMode ? b.toolbar.disableAll(a, []) : m(
						b.noDisableItems, function() {
							b.toolbar[a ? "disable" : "enable"](this)
						});
				o ? d.body.contentEditable = !a : d.designMode = a
						? "off"
						: "on";
			...
			createMenu : function(a) {
				...
				a.selectedColor !== i
						? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this
								.lang("noColor"), this.menu = Db(a))
						: (a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, this.menu = $a(a));
				return this.menu
			},
			hideMenu : function() {
				this.menu.remove();
		...
		Gb("core", function(a) {
			...
			b.afterCreate(function() {
						if (b.syncType == "form") {
							for (var c = a(b.srcElement), d = !1; c = c
									.parent();)
								if (c.name == "form") {
									d = !0;
									break
			...
			b.clickToolbar("source", function() {
						b.edit.designMode
								? (b.toolbar.disableAll(!0), b.edit.design(!1), b.toolbar
										.select("source"))
								: (b.toolbar.disableAll(!1), b.edit.design(!0), b.toolbar
										.unselect("source"), Y ? setTimeout(
										function() {
											b.cmd.selection()
										}, 0) : b.cmd.selection());
				...
				function c() {
					...
					X
							&& (a("div." + l, i).each(function() {
									...
									}), a("span.Apple-style-span", i)
									.remove(!0), a("span.Apple-tab-span", i)
									.remove(!0), a("span[style]", i).each(
									function() {
					...
					i.remove();
					d !== ""
							&& (X && (d = d.replace(/(<br>)\1/ig, "$1")), b.pasteType === 2
									&& (d = d
											.replace(
													/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig,
											...
											: (d = U(d, b.filterMode
															? b.htmlTags
															: null), d = b
													.beforeSetHtml(d))), b.pasteType === 1
									&& (d = d.replace(/&nbsp;/ig, " "), d = d
											.replace(/\n\s*\n/g, "\n"), d = d
											.replace(/<br[^>]*>/ig, "\n"), d = d
											.replace(/<\/p><p[^>]*>/ig, "\n"), d = d
											.replace(/<[^>]+>/g, ""), d = d
											.replace(/ {2}/g, " &nbsp;"), b.newlineTag == "p"
											? /\n/.test(d)
													&& (d = d
															.replace(/^/, "<p>")
															.replace(/$/,
				...
				a(d.body).bind("paste", function(p) {
							if (b.pasteType === 0)
								...
								if (o) {
									...
									f.range.selectNodeContents(i[0]), f
											.select();
								setTimeout(function() {
											c();
											m = !1
			...
			b.beforeGetHtml(function(a) {
				...
				return a
						...
						.replace(
								...
								function(a) {
									var a = I(a), b = ba(a.style || ""), c = pb(a["data-ke-tag"]), d = l(
											b.width, ""), b = l(b.height, "");
									/px/i.test(d) && (d = t(d));
									/px/i.test(b) && (b = t(b));
									c.width = l(a.width, d);
